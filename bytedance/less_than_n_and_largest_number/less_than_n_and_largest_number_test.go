...
func Test_lessThanNAndLargestNumber3(t *testing.T) {
	assert.EqualValues(t, 2499, lessThanNAndLargestNumber3(2533, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 9999, lessThanNAndLargestNumber3(12345, []int{6, 7, 9}))
	assert.EqualValues(t, 999, lessThanNAndLargestNumber3(2533, []int{0, 3, 9}))
	assert.EqualValues(t, 2499, lessThanNAndLargestNumber3(2533, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 0, lessThanNAndLargestNumber3(1, []int{0, 0}))
	assert.EqualValues(t, 222, lessThanNAndLargestNumber3(1111, []int{2}))
	//assert.EqualValues(t, 12121, lessThanNAndLargestNumber3(12121, []int{1, 2}))
	assert.EqualValues(t, 2449, lessThanNAndLargestNumber3(2451, []int{4, 2, 5, 9}))
	assert.EqualValues(t, 222, lessThanNAndLargestNumber3(1111, []int{2}))
	assert.EqualValues(t, 22222, lessThanNAndLargestNumber3(33333, []int{2}))
	assert.EqualValues(t, 313, lessThanNAndLargestNumber3(321, []int{1, 2, 3}))
	assert.EqualValues(t, 2, lessThanNAndLargestNumber3(3, []int{1, 2, 3}))
	assert.EqualValues(t, 43999, lessThanNAndLargestNumber3(44321, []int{4, 3, 9}))
	assert.EqualValues(t, 22555, lessThanNAndLargestNumber3(24131, []int{2, 4, 5}))
	assert.EqualValues(t, 2299, lessThanNAndLargestNumber3(2409, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 4919, lessThanNAndLargestNumber3(4921, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 1999, lessThanNAndLargestNumber3(2100, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 4955, lessThanNAndLargestNumber3(4956, []int{4, 5, 6, 9}))
	assert.EqualValues(t, 4949, lessThanNAndLargestNumber3(4956, []int{0, 4, 9}))
	assert.EqualValues(t, 99, lessThanNAndLargestNumber3(589, []int{6, 9}))
	assert.EqualValues(t, 1111, lessThanNAndLargestNumber3(4956, []int{1}))
	assert.EqualValues(t, 888, lessThanNAndLargestNumber3(1200, []int{6, 7, 8}))
	assert.EqualValues(t, 2555, lessThanNAndLargestNumber3(3211, []int{2, 3, 5}))
	assert.EqualValues(t, 1199, lessThanNAndLargestNumber3(1201, []int{1, 2, 9}))
	assert.EqualValues(t, 994, lessThanNAndLargestNumber3(999, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 999, lessThanNAndLargestNumber3(1111, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 2499, lessThanNAndLargestNumber3(2533, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 4919, lessThanNAndLargestNumber3(4921, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 1244, lessThanNAndLargestNumber3(1249, []int{1, 2, 4, 9}))
	assert.EqualValues(t, 22555, lessThanNAndLargestNumber3(24131, []int{2, 4, 5}))
}
